...
print("\n{}\n".format(output))
f0, f1, th = plot_sequential("/home/watermarkhu/mep/oop_surface_code/cartesiusdata/ufbb_toric_2d.csv",
                   probs=[round(0.099 + i*0.0005, 5) for i in range(11)])
if save: f0.savefig("/home/watermarkhu/mep/mep-thesis/pgfplots/{}.pgf".format(output))
if save: f1.savefig("/home/watermarkhu/mep/mep-thesis/pgfplots/{}_seq.pgf".format(output))

latex_style(1)
output = "threshold_ufbb_toric_2d_comp"
print("\n{}\n".format(output))
f2 = comp_thresholds([8+8*i for i in range(8)],"toric_2d", ['MWPM', "DBUF"], th)
if save: f2.savefig("/home/watermarkhu/mep/mep-thesis/pgfplots/{}.pgf".format(output))


latex_style(0.5, 1)
output = "threshold_ufbb_planar_2d_short"
print("\n{}\n".format(output))
f0, f1, th = plot_sequential("/home/watermarkhu/mep/oop_surface_code/cartesiusdata/ufbb_planar_2d.csv",
...
print("\n{}\n".format(output))
f0, f1, th = plot_sequential("/home/watermarkhu/mep/oop_surface_code/cartesiusdata/ufbb_toric_3d.csv", 
...
print("\n{}\n".format(output))
f0, f1, th = plot_sequential("/home/watermarkhu/mep/oop_surface_code/cartesiusdata/ufbb_planar_3d.csv",
            latts=[8+4*i for i in range(8)],
